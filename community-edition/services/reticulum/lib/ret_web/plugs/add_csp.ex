  ...
  defp generate_csp_rules(strict: false) do
    ...
    %{
      ...
      "script-src" => [
        ...
        "'sha256-HdoAyVHHhir7+8DfZLbxtfYc9gLaWgaL6GwPs6mic0k='",
        "'sha256-1OX1cqGDXGZOzQijoLpHf88OwS4EEX61lCMqICZfrGQ='",
        "'sha256-R+8PnBsB2H1En6tmpYadztHDOHsp2tWRUjkYhEnP4/w='",
        "'unsafe-eval'",
        "https://aframe.io",
